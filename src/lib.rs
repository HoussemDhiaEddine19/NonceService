...
#[derive(Debug)]
pub struct NonceServiceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NonceServiceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NonceService processing");
    
    let mut processor = NonceServiceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NonceServiceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NonceServiceProcessor::new(false);
